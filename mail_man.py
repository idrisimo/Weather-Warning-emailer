...
def run():
    ...
    schedule.every().wednesday.at('05:00').do(send_email, sender_email, receiver_email, email_password, message)
    schedule.every().friday.at('05:00').do(send_email, sender_email, receiver_email, email_password, message)
